...
namespace SuperAwesomeCode.Data
{
	...
	public class BatchedDataContext : IDisposable
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BatchedDataContext"/> class.
		/// </summary>
		/// <param name="objectContextsTypes">The object contexts types.</param>
		public BatchedDataContext(IEnumerable<Type> objectContextsTypes)
		{

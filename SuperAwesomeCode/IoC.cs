...
{
	/// <summary>
	/// 	Class that is used to retrieve objects using Inversion of Control.
	/// </summary>
	public static class IoC
	{
		...
		/// <summary>
		/// 	Use to resolve a type by using IoC.
		/// </summary>
		...
		/// <summary>
		/// 	Release's an object bound in IoC.
		/// </summary>
